    ...
    <section className="relative h-[50vh] flex items-center justify-center">
      ...
      <div className="relative z-10 text-center px-4">
        <AnimatedSection>
          ...
          <h1 className="font-heading text-4xl md:text-6xl font-bold mt-3">Our Story</h1>
        </AnimatedSection>
      </div>
    </section>
      ...
      <div className="container mx-auto max-w-4xl">
        <AnimatedSection className="text-center">
          <h2 className="font-heading text-3xl md:text-4xl font-bold mb-6">
            DD Event Management & <span className="gradient-gold-text">Catering Boys</span>
          </h2>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
          {stats.map((s, i) => (
            <AnimatedSection key={s.label} delay={i * 0.1} className="text-center">
              <div className="font-heading text-3xl md:text-4xl font-bold gradient-gold-text">{s.value}</div>
    ...
    <section className="section-padding bg-secondary/50">
      <div className="container mx-auto max-w-4xl">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <AnimatedSection>
            <div className="glass-card rounded-xl p-8 h-full hover-gold-glow">
              <div className="w-12 h-12 rounded-full gradient-gold-bg flex items-center justify-center mb-5">
